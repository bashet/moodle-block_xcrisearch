...
$string['qualtitle']                = 'Qualification Title';
$string['qualawardedby']            = 'Awarded by';
$string['prerequisite']             = 'Prerequisites';
$string['qualtitle']                = 'Qualification Title';
$string['qualawardedby']            = 'Awarded by';

$string['creditscheme']             = 'Credit Scheme';
$string['creditlevel']              = 'Credit Level';
$string['creditvalue']              = 'Credit Value';


$string['presentationstart']                = 'Credit Scheme';
